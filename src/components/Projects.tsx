...
const projects = [
  ...
  },
  {
    ...
    results: [
      "Pinpoints exact leak locations across entire funnel",
      "Calculates precise revenue impact per leak source",
      "Generates custom remediation roadmap with ROI",
    ],
    isLiveTool: true,
    liveUrl: "/lead-leaks-audit",
  },
  {
    icon: Brain,
