            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Industry benchmarks show missed or delayed follow-up rates between 20–40%, especially after hours.
                </p>
              </div>

              <div className="space-y-2">
                <Label htmlFor="conversionRate">Expected Conversion Rate: {inputs.conversionRate}%</Label>
                <Slider
                  id="conversionRate"
                  min={5}
                  max={50}
