  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-card to-background">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-destructive rounded-full blur-[140px] animate-glow" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4 py-12 md:py-20">
        <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-primary via-destructive to-accent bg-clip-text text-transparent leading-tight">
            How Much Revenue Are You Losing to Lead Leakage?
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground font-light max-w-3xl mx-auto">
            Most businesses lose 20-40% of their leads due to poor follow-up. Calculate your hidden costs in under 2 minutes.
          </p>
