  ...
  return <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-card to-background">
      ...
      <div className="container relative z-10 mx-auto px-4 py-12 md:py-20">
        <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground font-light max-w-3xl mx-auto">Most law firms lose 20-40% of their leads to intake leaks. Discover your lost revenue in under 2 minutes.</p>
